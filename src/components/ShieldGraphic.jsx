...
//       <div className="absolute w-[260px] h-[260px] rounded-full border border-cyberprimary/25 shadow-[0_0_40px_rgba(0,229,255,.15)_inset]">
//         <div className="absolute -inset-px rounded-full border-t-2 border-t-cyberprimary/70 border-r-2 border-r-transparent border-b-2 border-b-transparent border-l-2 border-l-transparent animate-rotateRing" />
//       </div>

//       {/* Inner holographic ring (reverse rotation) */}
//       <div className="absolute w-[220px] h-[220px] top-5 left-5 rounded-full border border-cyberprimary/25 shadow-[0_0_40px_rgba(0,229,255,.15)_inset] opacity-60">
//         <div className="absolute -inset-px rounded-full border-t-2 border-t-cyberprimary/70 border-r-2 border-r-transparent border-b-2 border-b-transparent border-l-2 border-l-transparent animate-rotateRingRev" />
//       </div>

//       {/* Animated circuit board pattern */}
//       <svg className="absolute w-[300px] h-[300px] opacity-35 animate-pulseFade" viewBox="0 0 300 300" fill="none">
...
//       <svg
//         className="relative z-[2] w-[150px] h-auto animate-shieldPulse"
//         viewBox="0 0 200 240"
//         fill="none"
